            ...
            <div id="MainCnt">
                ...
                <table style="border-collapse: collapse;width: 100%;">
                    <tr>
                        ...
                        <th style="text-align: left;padding: 8px;background-color: #4CAF50;color: white; width:12%;">Staff Out Time</th>
                        <th style="text-align: left;padding: 8px;background-color: #4CAF50;color: white; width:12%;">Click Staff Out</th>
                    </tr>
                    <%
                        try{
                            ...
                            pt = conn.prepareStatement("select * from visitors");
                    ...
                    <tr>
                        ...
                        <form action="StaffVisitorOut">
                            <input type="hidden" name="vIdTxt" value="<%= rs.getString(1)%>" />
                            <td style="text-align: left;padding: 8px;width:12%;">
                                <input type="submit" name="Visitor Out" name="Value Out" />
                            </td>
                        </form>
                    </tr>
                    <%
